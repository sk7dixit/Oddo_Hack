...
export const AuthComponent = ({ logo = <DefaultLogo />, brandName = "TraveLoop" }: AuthComponentProps) => {
...
useEffect(() => {
    if (modalStatus === 'success') {
        fireSideCanons();
        const timer = setTimeout(() => navigate("/complete-profile"), 2500);
                    ...
                    <BlurFade delay={0.1} className="w-full">
                        <div className="text-center space-y-2">
                            <p className="font-serif font-light text-4xl sm:text-5xl md:text-6xl tracking-tight text-foreground whitespace-nowrap">
                                Get started with <span className="text-cyan-400 font-medium">Us</span>
                            </p>
                            <p className="text-slate-400 text-sm font-medium">Immersive travel intelligence awaits</p>
                        </div>
                    </BlurFade>
                    ...
                    <BlurFade delay={0.2} className="w-full space-y-4 pt-4">
                        <div className="flex flex-col gap-4 w-full px-4">
                            ...
                            >
                                ...
                                <span className="font-semibold text-foreground">Continue with Microsoft</span>
                            </GlassButton>
                        </div>
                    </BlurFade>

                    <BlurFade delay={0.4} className="pt-8">
